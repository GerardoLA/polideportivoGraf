...
public class Inscripcion {
	...
	public Inscripcion(int id, String nombre, Date fecha_inicio, String dias_semana, int max_participantes,
			double precio) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public String toString() {
		return "Inscripcion [id=" + id + ", nombre=" + nombre + ", fecha_inicio=" + fecha_inicio + ", dias_semana="
				+ dias_semana + ", max_participantes=" + max_participantes + ", precio=" + precio + "]";
	}
